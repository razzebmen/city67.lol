    ...
    if lerp_rh != 0 then
        ...
        if shouldrebuild then
            ...
            if false and !ishgweapon(self) and ply.organism and ply.organism.rarm and ply.organism.rarm > 0.99 then
                ...
                local prevRPos = (segments[3] and segments[3].Pos) or hand
                segments[3] = {Pos = Lerp(1 - lerp_rh, ply.last_rh and ply.last_rh:GetTranslation() or prevRPos, ply_r_hand_matrix_old and ply_r_hand_matrix_old:GetTranslation() or hand), Len = 12}
            end
    ...
    if lerp_lh != 0 then
        ...
        if shouldrebuild then
            ...
            if ply.organism and ply.organism.larm and ply.organism.larm > 0.99 and ishgweapon(self) and !self.reload and ishgweapon(self) then
                ...
                local prevLPos = (segments[3] and segments[3].Pos) or hand
                segments[3] = {Pos = Lerp(1 - lerp_lh, ply.last_lh and ply.last_lh:GetTranslation() or prevLPos, ply_l_hand_matrix_old and ply_l_hand_matrix_old:GetTranslation() or hand), Len = 12}
            end
