...
hg.Accessories = {
    ...
    ["isis_band"] = {
        ...
        fempos = {Vector(-0.6,-0.6,0),Angle(180,100,90),0.95},
        skin = 0,
        -- city67: повязка ЦАХАЛ. Заменили SubMat на IDF-текстуры из аддона zcity_skins.
        SubMat = "Skins/Idf/Band_idf",
        SubMats = {[1] = "Skins/Idf/band_idf_tail"},
        disallowinappearance = true,
        bonemerge = true,
        needcoolRender = true,
        flex = true,
    ...
    ["medic_band"] = {
        ...
        fempos = {Vector(-0.6,-0.6,0),Angle(180,100,90),0.95},
        skin = 0,
        SubMat = "Bands/band_gray",
        SubMats = {[1] = "Bands/band_gray_tail"},
        disallowinappearance = true,
        bonemerge = true,
        needcoolRender = true,
        flex = true,
