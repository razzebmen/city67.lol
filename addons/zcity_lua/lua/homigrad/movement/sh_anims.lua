...
--\\ Custom running anim activity
	...
	hook.Add( "CalcMainActivity", "RunningAnim", function(ply, vel)
		...
		local isBerserk = ply.IsBerserk and ply:IsBerserk() or false
		local isAmputated = isBerserk and ply.organism and (ply.organism.llegamputated or ply.organism.rlegamputated)
