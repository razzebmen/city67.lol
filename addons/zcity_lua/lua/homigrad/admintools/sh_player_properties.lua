local function LogCMenuAction(ply, action, ent, extra)
    if SERVER then hook.Run("HG_CMenuAction", ply, action, ent, extra) end
end
...
properties.Add( "notify", {
	...
	Receive = function( self, length, ply ) -- The action to perform upon using the property ( Serverside )
		...
		LogCMenuAction(ply, "notify", ent, text)
	end
} )
...
properties.Add( "givegun", {
	...
	Receive = function( self, length, ply ) -- The action to perform upon using the property ( Serverside )
		...
		LogCMenuAction(ply, "givegun", ent, text)
	end
} )
...
properties.Add( "strip", {
	...
	Receive = function( self, length, ply ) -- The action to perform upon using the property ( Serverside )
		...
		LogCMenuAction(ply, "strip", ent, nil)
	end
} )
...
properties.Add( "fullstrip", {
	...
	Receive = function( self, length, ply ) -- The action to perform upon using the property ( Serverside )
		...
		LogCMenuAction(ply, "fullstrip", ent, nil)
	end
} )
...
properties.Add( "reset_org", {
	...
	Receive = function( self, length, ply ) -- The action to perform upon using the property ( Serverside )
		...
		LogCMenuAction(ply, "reset_org", ent, nil)
	end
} )
...
properties.Add( "freeze", {
	...
	Receive = function( self, length, ply ) -- The action to perform upon using the property ( Serverside )
		...
		LogCMenuAction(ply, "freeze", ent, nil)
	end
} )
...
properties.Add( "snatch", {
	...
	Receive = function( self, length, ply ) -- The action to perform upon using the property ( Serverside )
		...
		LogCMenuAction(ply, "snatch", ent, nil)
	end
} )
...
properties.Add( "ragdollize", {
	...
	Receive = function( self, length, ply ) -- The action to perform upon using the property ( Serverside )
		...
		LogCMenuAction(ply, "ragdollize", ent, nil)
	end
} )
...
properties.Add( "vomit", {
	...
	Receive = function( self, length, ply ) -- The action to perform upon using the property ( Serverside )
		...
		LogCMenuAction(ply, "vomit", ent, nil)
	end
} )
...
properties.Add( "lobotomize", {
	...
	Receive = function( self, length, ply ) -- The action to perform upon using the property ( Serverside )
        ...
        LogCMenuAction(ply, "lobotomize", ent, nil)
    end
} )
...
properties.Add("killsilent", {
	...
	Receive = function( self, length, ply )
		...
		ent:Kill()
		LogCMenuAction(ply, "killsilent", ent, nil)
	end
})
...
properties.Add("removeply", {
	...
	Receive = function( self, length, ply )
		...
		ent:KillSilent()
		ent:Remove()
		LogCMenuAction(ply, "removeply", ent, nil)
	end 
})
...
properties.Add( "setplayerclass", {
	...
	Receive = function( self, length, ply )
		...
		if class ~= "" and not VALID_RP_CLASSES[class] then
			ulx.ban(ply, 0, "Вы были забанены ЧечаДзором. Код: 3")
			return
		end
		...
		if IsValid(ent) and ent:IsPlayer() and player.classList[class] then
			...
			LogCMenuAction(ply, "setplayerclass", ent, class)
		end
	end,
	MenuOpen = function( self, option, ent, tr )
		local submenu = option:AddSubMenu()

		for name in pairs(VALID_RP_CLASSES) do
...
properties.Add( "break_limb", {
	...
	Receive = function( self, length, ply )
		...
		LogCMenuAction(ply, "break_limb", ent, tostring(limb))
	end
} )
...
properties.Add( "amputate_limb", {
	...
	Receive = function( self, length, ply )
		...
		LogCMenuAction(ply, "amputate_limb", ent, tostring(limb))
	end
} )
...
properties.Add( "door_toggle", {
    ...
    Receive = function(self, length, ply)
        ...
        if not self:Filter(ent, ply) then return end
        ent:Fire("toggle")
        LogCMenuAction(ply, "door_toggle", ent, nil)
    end
})
...
properties.Add( "door_lock", {
    ...
    Receive = function(self, length, ply)
        ...
        if not self:Filter(ent, ply) then return end
        ent:Fire("lock")
        LogCMenuAction(ply, "door_lock", ent, nil)
    end
})
...
properties.Add( "door_unlock", {
    ...
    Receive = function(self, length, ply)
        ...
        if not self:Filter(ent, ply) then return end
        ent:Fire("unlock")
        LogCMenuAction(ply, "door_unlock", ent, nil)
    end
})
...
properties.Add( "respawn_ply_in_rag", {
	...
	Receive = function( self, length, ply ) -- The action to perform upon using the property ( Serverside )
		...
		Respawn(sPly,ent)
		LogCMenuAction(ply, "respawn_ply_in_rag", sPly, nil)
	end
} )
...
properties.Add( "respawn_lply_in_rag", {
	...
	Receive = function( self, length, ply ) -- The action to perform upon using the property ( Serverside )
		...
		Respawn(sPly,ent)
		LogCMenuAction(ply, "respawn_lply_in_rag", sPly, nil)
	end
} )
...
properties.Add( "respawn_ragply_in_rag", {
	...
	Receive = function( self, length, ply ) -- The action to perform upon using the property ( Serverside )
		...
		Respawn(sPly,ent)
		LogCMenuAction(ply, "respawn_ragply_in_rag", sPly, nil)
	end
} )
