...
function TOOL:DrawToolScreen(width, height)
	...
	local pointName = point_editor:GetString()
	local pointData = zb.Points and zb.Points[pointName]
	local pointColor = (pointData and pointData.Color) or color_white
	draw.SimpleText(pointName, "ZB_ScrappersSmall", width / 2, height * 0.7, pointColor, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
end