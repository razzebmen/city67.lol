...
GM.Config.normalsalary                  = 100 -- ZCity: дефолт citizen salary 100$
-- npckillpay - Sets the money given for each NPC kill.
GM.Config.npckillpay                    = 10
-- paydelay - Sets how long it takes before people get salary.
GM.Config.paydelay                      = 300 -- ZCity: каждые 5 минут (как в старом roleplay)
...
GM.Config.respawntime                   = 15 -- ZCity: 15 сек как в старом RoleplayAutoRespawn
...
GM.Config.startingmoney                 = 5000 -- ZCity: 5000$ как в sv_roleplay.lua
