...
local blackColor = Color( 10, 10, 10 )
...
function PANEL:DrawLine( w, h )
	...
	draw.RoundedBox( 6, 0, h/2 - 4, self.m_fSlideX * w, 8, Color( 170, 0, 0 ) )
end  
...
function PANEL:Init() 
	...
	self.primaryColor = Color( 180, 0, 0 )
	self.secondaryColor = Color( 120, 0, 0 )
	self.backgroundColor = Color( 15, 15, 15 )
